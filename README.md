...
I’m a **software engineering student** focused on **Python backend development**, with a strong interest in building systems that resemble **real-world production software** rather than isolated demo projects.

### 💻 How I Approach Development

I treat software development as an **iterative engineering process**, not just writing code.  
In my projects, I aim to work in a way similar to professional development teams:

- Working **iteratively**, using **Scrum-inspired workflows**
- Writing **user stories** and defining acceptance criteria
- Designing **user flows** to understand feature interactions
...
- Thoughtful, explicit design decisions
- Learning industry best practices through hands-on implementation
